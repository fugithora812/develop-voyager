      ...
      <div className="flex items-start justify-between">
              ...
              <div>
                ...
                >
                  ...
                  <span className="mx-2 text-sm font-normal">
                    Refered Projects
                    <span className="w-4 h-2 p-1 ml-4 text-xs text-gray-400 bg-gray-200 rounded-lg">0</span>
                  </span>
                </a>
                <a
                  className="flex items-center justify-start w-full p-2 pl-6 my-2 text-gray-400 transition-colors duration-200 border-l-4 border-transparent hover:text-gray-800"
        ...
        <div className="flex flex-col w-full md:space-y-4">
          ...
          <div className="h-screen px-4 pb-24 overflow-auto md:px-6">
            <h1 className="text-4xl font-semibold text-gray-800 dark:text-white">Welcome To My Blog</h1>
            <h2 className="text-gray-400 text-md">Here&#x27;s List of Articles</h2>
            <br />
              ...
              <div className="m-auto overflow-hidden rounded-lg shadow-lg cursor-pointer h-90 w-60 md:w-80">
                <a href="#" className="block w-full h-full">
                  ...
                  <div className="w-full p-4 bg-white dark:bg-gray-800">
                    ...
                    <p className="mb-2 text-xl font-medium text-gray-800 dark:text-white">Supercharged</p>
